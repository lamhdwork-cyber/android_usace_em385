...
var className = "hl"; //process for dark mode
function initHighlighter(name, text) {
  className = name;
  rangy.init();
  highlighter = rangy.createHighlighter();
  highlighter.addClassApplier(rangy.createClassApplier(name));
  myLoadHighlights(text);
}

function myHighlightSelection() {
  if (highlighter !== null)
    highlighter.highlightSelection(className);
  return myShowHighlights();
}

function myRemoveHighlights() {
  if (highlighter !== null)
    highlighter.unhighlightSelection(); //.removeAllHighlights();
  return myShowHighlights();
}

function myShowHighlights() {
  if (highlighter !== null) {
...
function myLoadHighlights(text) {
  if ((highlighter !== null) && text) {
    highlighter.deserialize(text);
