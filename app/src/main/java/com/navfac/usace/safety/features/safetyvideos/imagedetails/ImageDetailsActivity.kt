...
class ImageDetailsActivity : BaseActivity<ActivityImageDetailsBinding>() {
    ...
    private lateinit var vm: ImageDetailsViewModel
    ...
    override fun onCreated(instance: Bundle?) {
        vm = ViewModelProvider(this)[ImageDetailsViewModel::class.java]
        ...
        try {
            ...
            binding.includetoolbar.dtoolbardownload.setOnClickListener {
                vm.saveImageToGallery(this, terms!!, binding.photoView)
            }
