...
class ExpandableAdapter internal constructor(
    ...
    override fun getGroupView(listPosition: Int, isExpanded: Boolean, convertView: View?, parent: ViewGroup): View {
        ...
        if (resultView == null) {
            val layoutInflater = this.context.getSystemService(Context.LAYOUT_INFLATER_SERVICE) as LayoutInflater
            resultView = layoutInflater.inflate(R.layout.list_group, null)
        }

        val listTitleTextView = resultView!!.findViewById<TextView>(R.id.listTitle)
        val face = Typeface.createFromAsset(context.assets,"fonts/senserif.ttf")
        listTitleTextView.setTypeface(face, Typeface.BOLD)
